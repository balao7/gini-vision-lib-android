        ...
        stage('Instrumentation Tests') {
            steps {
                withEnv(["PATH+TOOLS=$ANDROID_HOME/tools", "PATH+TOOLS_BIN=$ANDROID_HOME/tools/bin", "PATH+PLATFORM_TOOLS=$ANDROID_HOME/platform-tools"]) {
                    sh 'scripts/start-emulator.sh mobilecd_android-26_google_apis-x86_512M -prop persist.sys.language=en -prop persist.sys.country=US -gpu on -camera-back emulated > emulator_port'
